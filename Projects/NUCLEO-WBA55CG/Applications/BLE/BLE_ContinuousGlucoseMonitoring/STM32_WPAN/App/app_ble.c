...
CGMS_APP_ConnHandleNotEvt_t CGMSHandleNotification;
DIS_APP_ConnHandleNotEvt_t DISHandleNotification;
BMS_APP_ConnHandleNotEvt_t BMSHandleNotification;

static const char a_GapDeviceName[] = {  'C', 'o', 'n', 't', 'i', 'n', 'u', 'o', 'u', 's', ' ', 'G', 'l', 'u', 'c', 'o', 's', 'e', ' ', 'M', 'o', 'n', 'i', 't', 'o', 'r', 'i', 'n', 'g', ' ', 'S', 'e', 'n', 's', 'o', 'r' }; /* Gap Device Name */

/* Advertising Data */
uint8_t a_AdvData[28] =
{
  7, AD_TYPE_COMPLETE_LOCAL_NAME, 'C', 'G', 'M', '_', 'X', 'X',  /* Complete name */
  3, AD_TYPE_16_BIT_SERV_UUID_CMPLT_LIST, 0x1F, 0x18,
...
SVCCTL_UserEvtFlowStatus_t SVCCTL_App_Notification(void *p_Pckt)
{
  ...
  switch (p_event_pckt->evt)
  {
    case HCI_DISCONNECTION_COMPLETE_EVT_CODE:
    {
      ...
      CGMSHandleNotification.EvtOpcode = CGMS_DISCON_HANDLE_EVT;
      DISHandleNotification.EvtOpcode = DIS_DISCON_HANDLE_EVT;
      BMSHandleNotification.EvtOpcode = BMS_DISCON_HANDLE_EVT;
      CGMSHandleNotification.ConnectionHandle = p_disconnection_complete_event->Connection_Handle;
      DISHandleNotification.ConnectionHandle = p_disconnection_complete_event->Connection_Handle;
      BMSHandleNotification.ConnectionHandle = p_disconnection_complete_event->Connection_Handle;
      CGMS_APP_EvtRx(&CGMSHandleNotification);
      DIS_APP_EvtRx(&DISHandleNotification);
      BMS_APP_EvtRx(&BMSHandleNotification);
    ...
    case HCI_LE_META_EVT_CODE:
    {
      ...
      switch (p_meta_evt->subevent)
      {
        ...
        case HCI_LE_ENHANCED_CONNECTION_COMPLETE_SUBEVT_CODE:
        {
          ...
          CGMSHandleNotification.EvtOpcode = CGMS_CONN_HANDLE_EVT;
          DISHandleNotification.EvtOpcode = DIS_CONN_HANDLE_EVT;
          BMSHandleNotification.EvtOpcode = BMS_CONN_HANDLE_EVT;
          CGMSHandleNotification.ConnectionHandle = p_enhanced_conn_complete->Connection_Handle;
          DISHandleNotification.ConnectionHandle = p_enhanced_conn_complete->Connection_Handle;
          BMSHandleNotification.ConnectionHandle = p_enhanced_conn_complete->Connection_Handle;
          CGMS_APP_EvtRx(&CGMSHandleNotification);
          DIS_APP_EvtRx(&DISHandleNotification);
          BMS_APP_EvtRx(&BMSHandleNotification);
        ...
        case HCI_LE_CONNECTION_COMPLETE_SUBEVT_CODE:
        {
          ...
          DISHandleNotification.EvtOpcode = DIS_CONN_HANDLE_EVT;
          BMSHandleNotification.EvtOpcode = BMS_CONN_HANDLE_EVT;
          CGMSHandleNotification.ConnectionHandle = p_conn_complete->Connection_Handle;
          DISHandleNotification.ConnectionHandle = p_conn_complete->Connection_Handle;
          BMSHandleNotification.ConnectionHandle = p_conn_complete->Connection_Handle;
          CGMS_APP_EvtRx(&CGMSHandleNotification);
          DIS_APP_EvtRx(&DISHandleNotification);
          BMS_APP_EvtRx(&BMSHandleNotification);
    ...
    case AD_TYPE_MANUFACTURER_SPECIFIC_DATA:
      {
        ...
        p_adv_data[i+6] = FW_ID_CONTINUOUS_GLUCOSE_MEASUREMENT; /* FW ID */
